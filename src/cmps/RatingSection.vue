<template>
  <section>
    <div class="rate-book-continaer" v-if="!ratePermission">
      <h1>Thank you!</h1>
    </div>
    <div v-else class="rate-book-continaer">
      <h1>Rate now!</h1>
      <fieldset class="rating" @input="rateBook">
...
export default {
  ...
  methods: {
    ...
    rateBook({ target }) {
      this.bookRating = +target.value;
      this.$emit("rateBook", this.bookRating);
